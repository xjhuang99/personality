...
CONFIG = {
    "QWEN_API_KEY": "xxx", # put your api key here
    "INPUT_EXCEL_PATH": "/Users/huangxinjie/Desktop/personality/CFAEFA/survey.xlsx",
    "OUTPUT_EXCEL_PATH": "/Users/huangxinjie/Desktop/personality/CFAEFA/surveyqwen.xlsx",
    "SHEET_NAME": "Sheet3",
...
def rate_chat_with_qwen(client, chat_content: str, response_id: str):
    """Rate chat using Qwen model with consistent prompt"""
...
2. Disclosure Depth (1-7 scale):
   Rate the depth of personal information disclosure shared by humans on this 7-point scale.
   1. No Personal Information: Purely general statements (e.g., "The weather is nice," "That's interesting")
   2. Basic Preferences: Simple likes/dislikes without context (e.g., "I like pizza," "I watch movies," "I use Instagram")
   3. Basic Facts: Demographics and routines (e.g., "I'm a student," "I live in New York," "I go to the gym regularly")
   4. Personal Experiences: Specific situations and basic relationships (e.g., "I'm struggling in math class," "I've been dating someone for 2 months," "I argued with my roommate")
   5. Emotional Challenges: Detailed feelings and personal difficulties (e.g., "I'm anxious about my career choices," "My parents' divorce is affecting me deeply," "I'm struggling with self-confidence")
   6. Sensitive Information: Private struggles and vulnerabilities (e.g., "I'm dealing with depression," "My partner cheated on me," "I'm in significant debt")
   7. Highly Personal Information: Trauma, serious conditions, or deeply private matters (e.g., "I experienced childhood abuse," "I'm having suicidal thoughts," "I have a serious medical condition")
...
{{
    ...
    "responseID": "{response_id}"
            ...
            print(f"⚠️ Qwen rate limit (Attempt {attempt}/{CONFIG['MAX_RETRIES']}, ID:{response_id}), waiting {delay}s...")
            time.sleep(delay)
...
def process_row(client, row, save_dir):
    """Process single row with Qwen API"""
...
def process_chat_ratings():
    """Main processing function for Qwen API"""
